...
export default function Screen_04() {
  const images = [
    {
      url: require("../assets/Data/Container_7_2.png"),
      priceXS: 1.99,
      priceS: 2.99,
      priceM: 3.99,
      priceL: 4.99,
    ...
    {
      url: require("../assets/Data/Container_7_1.png"),
      priceXS: 1.99,
      priceS: 2.99,
      priceM: 3.99,
      priceL: 4.99,
    ...
    {
      url: require("../assets/Data/Container_7_3.png"),
      priceXS: 1.99,
      priceS: 2.99,
      priceM: 3.99,
      priceL: 4.99,
    ...
    {
      url: require("../assets/Data/Container_7.png"),
      priceXS: 1.99,
      priceS: 2.99,
      priceM: 3.99,
      priceL: 4.99,
  ...
  const [imgCurrent, setImgCurrent] = useState(
    require("../assets/Data/Container_7_3.png")
  );
        ...
        <View style={{ backgroundColor: "white", flex: 1 }}>
          <View style={{ flex: 1, paddingHorizontal: 16, paddingTop: 16 }}>
            ...
            >
              ...
              >
                <Image source={require("../assets/Data/Rating_3.png")} />
                <Text>4.5</Text>
              </View>
            </View>
